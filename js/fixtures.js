$(function () {
    ...
    lorem1 =  '<h1>Title 1</h1>' + loremText + '<img src="images/paolo.jpg">' + loremText;
    lorem2 =  '<h1>Title 2</h1>' + loremText + '<img src="images/gente.jpg">' + loremText + loremText;
    lorem3 =  '<h1>Title 3</h1>' + loremText + '<img src="images/gente2.jpg">' + loremText;
